---
title: 'NVIM and ElixirLS - New User Edition'
description: 'It is one thing to work on a big projects with a team, another to develop something useful as a solo developer. This is my 3 month journey building Sprytna.cards, hopefully it is useful.'
pubDate: 'Aug 10 2024'
heroImage: '../../assets/blog/hero-nvim-elixirls.png'
---


_The following is what I did, as a new user in the Vim ecosystem, to configure Neovim as my daily editor for Elixir development._
...
![screenshot](/blog/nvim-elixirls/screenshot1.png)
