...
description: 'Just starting with RabbitMQ? This introductory guide will walk you through setting up a local RabbitMQ sandbox. Then we will use RabbitMQ to send messages from Elixir to Node.'
pubDate: 'Apr 30 2024'
heroImage: '../../assets/writing/hero-first-hops-rabbitmq.png'
---



_This introductory guide will walk you through setting up a local RabbitMQ sandbox. Then we will use RabbitMQ to pass messages from Elixir to Node._
...
![docker](/writing/first-hops/image1.png)
...
![RabbitMQ Log In](/writing/first-hops/image2.png)

Once you are logged in you will see the Overview Page.

![RabbitMQ Admin](/writing/first-hops/image3.png)
...
![livebook screenshot](/writing/first-hops/image4.png)

And you should have a brand new empty project page.

![livebook](/writing/first-hops/image5.png)

Hover over "Notebook dependencies and setup" and add our `:amqp` dependency.

![livebook](/writing/first-hops/image6.png)
...
![livebook](/writing/first-hops/image7.png)
...
![livebook](/writing/first-hops/image8.png)
...
![livebook](/writing/first-hops/image9.png)
...
I hope you found this post helpful. Feel free to email me at [mike @ mkumm.com](mailto:mike@mkumm.com) with any feedback or questions.
