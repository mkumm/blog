---
title: 'When a Hobby Project Breaks'
description: 'Yesterday, my hobby project experienced an unexpected 8-hour outage. It was an extremely frustrating and humbling experience that sparked deeper reflection: where is the line between a fun little side project and something others depend on?'
pubDate: 'Jul 26 2025'
heroImage: '../../assets/writing/hero-when-a-hobby-breaks.png'
---
...
```
 ...
 <p class="bg-yellow-100 px-3 py-1">Don’t run this command on an unsupported Postgres cluster.</p>
