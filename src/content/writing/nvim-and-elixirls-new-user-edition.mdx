...
description: 'The following is what I did, as a new user in the Vim ecosystem, to configure Neovim as my daily editor for Elixir development.'
pubDate: 'Aug 10 2024'
heroImage: '../../assets/writing/hero-nvim-elixirls.png'
---
...
![screenshot](/writing/nvim-elixirls/screenshot1.png)
