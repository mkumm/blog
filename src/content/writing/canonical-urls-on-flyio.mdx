...
description: 'How to configure your static site to use your canonical url - dropping the `www` and redirecting traffic to your apex domain name on Fly.io.'
pubDate: 'Apr 04 2024'
heroImage: '../../assets/writing/hero-canonical-url-fly.png'
---



_How to configure your static site to use your canonical URL, dropping the "www" and redirecting traffic to your apex domain name, on Fly.io._
